        ...
        <div className="min-h-screen bg-[#F5F5F7] dark:bg-black pt-24 pb-12 px-4 font-sans">
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 items-start relative z-10">
                {currentData.packages.map((pkg, idx) => {
                    ...
                    if (isHit) {
                        return (
                            <div key={idx} className="bg-gradient-to-b from-[#0071e3]/10 to-[#1c1c1e] dark:from-[#0071e3]/20 dark:to-[#151517] rounded-[2.5rem] p-8 border-2 border-[#0071e3] shadow-2xl shadow-[#0071e3]/30 relative transform md:-translate-y-4 z-20 group overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#0071e3]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
